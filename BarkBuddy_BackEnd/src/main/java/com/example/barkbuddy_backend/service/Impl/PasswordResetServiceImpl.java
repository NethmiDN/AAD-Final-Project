...
import com.example.barkbuddy_backend.entity.PasswordResetOtp;
...
public class PasswordResetServiceImpl implements PasswordResetService {
    ...
    private void sendOtpEmail(String toEmail, String otp) throws MessagingException {
        ...
        helper.setSubject("🐕 BarkBuddy Password Reset - OTP Verification");
    ...
    private String buildOtpEmailBody(String otp) {
        return "<div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f8f9fa;\">" +
               ...
               "    <h1 style=\"color: white; margin: 0; font-size: 28px;\">🐕 BarkBuddy</h1>" +
               ...
               "      <p style=\"color: #666; margin: 0; font-size: 14px;\">Need help? Contact our support team at barkbuddyinf@gmail.com</p>" +
               "    </div>" +
               "  </div>" +
               "  <div style=\"text-align: center; padding: 20px; color: #666; font-size: 12px;\">" +
               "    <p>© 2025 BarkBuddy. All rights reserved.</p>" +
               "  </div>" +
               "</div>";
    }
}